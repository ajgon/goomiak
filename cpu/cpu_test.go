...
func TestWriteWord(t *testing.T) {
	...
	gotH, gotL := dmaX.GetMemoryByte(0x1234), dmaX.GetMemoryByte(0x1235)
...
func TestLd_Bc_A(t *testing.T) {
	...
	checkCpu(t, 7, map[string]uint16{"PC": 1, "A": 0x7a, "BC": 0x1015, "WZ": 0x7a16}, cpu.ld_Bc_A)

	got := dmaX.GetMemoryByte(0x1015)
	want := uint8(0x7A)
	if got != want {
...
func TestIncB(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x1102, "Flags": 0b00000001}, cpu.incR('B'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.BC = 0xff02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0002, "Flags": 0b01010000}, cpu.incR('B'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.BC = 0x7f02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x8002, "Flags": 0b10010100}, cpu.incR('B'))
}
...
func TestDecB(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0002, "Flags": 0b01000011}, cpu.decR('B'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.BC = 0x0002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0xff02, "Flags": 0b10111010}, cpu.decR('B'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.BC = 0x8002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x7f02, "Flags": 0b00111110}, cpu.decR('B'))
}
...
func TestRlca(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x19, "Flags": 0b11001101}, cpu.rlcR(' '))

	resetAll()
	cpu.setAcc(0x4d)
	cpu.setFlags(0b11010111)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x9a, "Flags": 0b11001100}, cpu.rlcR(' '))
}
...
func TestAddHlBc(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "BC": 0xa76c, "HL": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("HL", "BC"))
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "BC": 0x7fff, "HL": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("HL", "BC"))
}
...
func TestAddIxBc(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "BC": 0xa76c, "IX": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IX", "BC"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "BC": 0x7fff, "IX": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IX", "BC"))
}
...
func TestAddIyBc(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "BC": 0xa76c, "IY": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IY", "BC"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "BC": 0x7fff, "IY": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IY", "BC"))
}
...
func TestLdA_Bc_(t *testing.T) {
	...
	checkCpu(t, 7, map[string]uint16{"PC": 1, "A": 0x64, "BC": 0x1257, "WZ": 0x1258}, cpu.ldA_Bc_)
}
...
func TestIncC(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0211, "Flags": 0b00000001}, cpu.incR('C'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.BC = 0x02ff
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0200, "Flags": 0b01010000}, cpu.incR('C'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.BC = 0x027f
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0280, "Flags": 0b10010100}, cpu.incR('C'))
}
...
func TestDecC(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x0200, "Flags": 0b01000011}, cpu.decR('C'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.BC = 0x0200
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x02ff, "Flags": 0b10111010}, cpu.decR('C'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.BC = 0x0280
	checkCpu(t, 4, map[string]uint16{"PC": 1, "BC": 0x027f, "Flags": 0b00111110}, cpu.decR('C'))
}
...
func TestRrca(t *testing.T) {
	...
	cpu.setAcc(0x8d)
	cpu.setFlags(0b11010110)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0xc6, "Flags": 0b11000101}, cpu.rrcR(' '))

	resetAll()
	cpu.setAcc(0x4c)
	cpu.setFlags(0b11010111)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x26, "Flags": 0b11100100}, cpu.rrcR(' '))
}
...
func TestDjnzN(t *testing.T) {
	...
	checkCpu(t, 13, map[string]uint16{"PC": 0x37, "WZ": 0x37, "BC": 0x1134}, cpu.djnzN)
	...
	checkCpu(t, 8, map[string]uint16{"PC": 0x05, "WZ": 0x1185, "BC": 0x0034}, cpu.djnzN)
	...
	checkCpu(t, 13, map[string]uint16{"PC": 0x37, "WZ": 0x37, "BC": 0xff34}, cpu.djnzN)
	...
	checkCpu(t, 13, map[string]uint16{"PC": 0x00, "WZ": 0x00, "BC": 0x0434}, cpu.djnzN)
}
...
func TestLd_De_A(t *testing.T) {
	...
	checkCpu(t, 7, map[string]uint16{"PC": 1, "A": 0x7a, "DE": 0x1015, "WZ": 0x7a16}, cpu.ld_De_A)
...
func TestIncD(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x1102, "Flags": 0b00000001}, cpu.incR('D'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.DE = 0xff02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0002, "Flags": 0b01010000}, cpu.incR('D'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.DE = 0x7f02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x8002, "Flags": 0b10010100}, cpu.incR('D'))
}
...
func TestDecD(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0002, "Flags": 0b01000011}, cpu.decR('D'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.DE = 0x0002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0xff02, "Flags": 0b10111010}, cpu.decR('D'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.DE = 0x8002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x7f02, "Flags": 0b00111110}, cpu.decR('D'))
}
...
func TestRla(t *testing.T) {
	...
	cpu.setAcc(0x8c)
	cpu.setFlags(0b11010110)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x18, "Flags": 0b11001101}, cpu.rlR(' '))

	resetAll()
	cpu.setAcc(0x4d)
	cpu.setFlags(0b11010111)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x9b, "Flags": 0b11001100}, cpu.rlR(' '))
}
...
func TestJrN(t *testing.T) {
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x37, "WZ": 0x37}, cpu.jrN)
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x00, "WZ": 0x00}, cpu.jrN)
}
...
func TestAddHlDe(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "DE": 0xa76c, "HL": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("HL", "DE"))
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "DE": 0x7fff, "HL": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("HL", "DE"))
}
...
func TestAddIxDe(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "DE": 0xa76c, "IX": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IX", "DE"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "DE": 0x7fff, "IX": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IX", "DE"))
}
...
func TestAddIyDe(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "DE": 0xa76c, "IY": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IY", "DE"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "DE": 0x7fff, "IY": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IY", "DE"))
}
...
func TestLdA_De_(t *testing.T) {
	...
	checkCpu(t, 7, map[string]uint16{"PC": 1, "A": 0x64, "DE": 0x1257, "WZ": 0x1258}, cpu.ldA_De_)
}
...
func TestIncE(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0211, "Flags": 0b00000001}, cpu.incR('E'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.DE = 0x02ff
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0200, "Flags": 0b01010000}, cpu.incR('E'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.DE = 0x027f
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0280, "Flags": 0b10010100}, cpu.incR('E'))
}
...
func TestDecE(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x0200, "Flags": 0b01000011}, cpu.decR('E'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.DE = 0x0200
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x02ff, "Flags": 0b10111010}, cpu.decR('E'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.DE = 0x0280
	checkCpu(t, 4, map[string]uint16{"PC": 1, "DE": 0x027f, "Flags": 0b00111110}, cpu.decR('E'))
}
...
func TestRra(t *testing.T) {
	...
	cpu.setAcc(0x8d)
	cpu.setFlags(0b11010110)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x46, "Flags": 0b11000101}, cpu.rrR(' '))

	resetAll()
	cpu.setAcc(0x4c)
	cpu.setFlags(0b11010111)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0xa6, "Flags": 0b11100100}, cpu.rrR(' '))
}
...
func TestJrNzN(t *testing.T) {
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x37, "WZ": 0x37, "Flags": 0b10010111}, cpu.jrNzN)
	...
	checkCpu(t, 7, map[string]uint16{"PC": 0x05, "WZ": 0x37, "Flags": 0b11010111}, cpu.jrNzN)
}
...
func TestLd_Nn_Hl(t *testing.T) {
	...
	checkCpu(t, 5, map[string]uint16{"PC": 3, "HL": 0x483a, "WZ": 0xb22a}, cpu.ld_Nn_Ss("HL"))

	gotH, gotL := dmaX.GetMemoryByte(0xb229), dmaX.GetMemoryByte(0xb22a)
...
func TestIncH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x1102, "Flags": 0b00000001}, cpu.incR('H'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.HL = 0xff02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0002, "Flags": 0b01010000}, cpu.incR('H'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.HL = 0x7f02
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x8002, "Flags": 0b10010100}, cpu.incR('H'))
}
...
func TestIncIXH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x1102, "Flags": 0b00000001}, cpu.incR('X'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.IX = 0xff02
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0002, "Flags": 0b01010000}, cpu.incR('X'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.IX = 0x7f02
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x8002, "Flags": 0b10010100}, cpu.incR('X'))
}
...
func TestIncIYH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x1102, "Flags": 0b00000001}, cpu.incR('Y'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.IY = 0xff02
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0002, "Flags": 0b01010000}, cpu.incR('Y'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.IY = 0x7f02
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x8002, "Flags": 0b10010100}, cpu.incR('Y'))
}
...
func TestDecH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0002, "Flags": 0b01000011}, cpu.decR('H'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.HL = 0x0002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0xff02, "Flags": 0b10111010}, cpu.decR('H'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.HL = 0x8002
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x7f02, "Flags": 0b00111110}, cpu.decR('H'))
}
...
func TestDecIXH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0002, "Flags": 0b01000011}, cpu.decR('X'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.IX = 0x0002
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0xff02, "Flags": 0b10111010}, cpu.decR('X'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.IX = 0x8002
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x7f02, "Flags": 0b00111110}, cpu.decR('X'))
}
...
func TestDecIYH(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0002, "Flags": 0b01000011}, cpu.decR('Y'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.IY = 0x0002
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0xff02, "Flags": 0b10111010}, cpu.decR('Y'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.IY = 0x8002
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x7f02, "Flags": 0b00111110}, cpu.decR('Y'))
}
...
func TestJrZN(t *testing.T) {
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x37, "WZ": 0x37, "Flags": 0b11010111}, cpu.jrZN)
	...
	checkCpu(t, 7, map[string]uint16{"PC": 0x05, "WZ": 0x37, "Flags": 0b10010111}, cpu.jrZN)
}
...
func TestAddHlHl(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "HL": 0x5cd8, "WZ": 0xae6d, "Flags": 0b00011001}, cpu.addSsRr("HL", "HL"))

	resetAll()
	cpu.HL = 0x7fff
	cpu.setFlags(0b00000010)

	checkCpu(t, 11, map[string]uint16{"PC": 1, "HL": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("HL", "HL"))
}
...
func TestAddIxIx(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "IX": 0x5cd8, "WZ": 0xae6d, "Flags": 0b00011001}, cpu.addSsRr("IX", "IX"))

	resetAll()
	cpu.IX = 0x7fff
	cpu.setFlags(0b00000010)

	checkCpu(t, 15, map[string]uint16{"PC": 2, "IX": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IX", "IX"))
}
...
func TestAddIyIy(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "IY": 0x5cd8, "WZ": 0xae6d, "Flags": 0b00011001}, cpu.addSsRr("IY", "IY"))

	resetAll()
	cpu.IY = 0x7fff
	cpu.setFlags(0b00000010)

	checkCpu(t, 15, map[string]uint16{"PC": 2, "IY": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IY", "IY"))
}
...
func TestLdHl_Nn_(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 3, "HL": 0xa137, "WZ": 0xb22a}, cpu.ldSs_Nn_("HL"))
}
...
func TestIncL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0211, "Flags": 0b00000001}, cpu.incR('L'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.HL = 0x02ff
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0200, "Flags": 0b01010000}, cpu.incR('L'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.HL = 0x027f
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0280, "Flags": 0b10010100}, cpu.incR('L'))
}
...
func TestIncIXL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0211, "Flags": 0b00000001}, cpu.incR('x'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.IX = 0x02ff
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0200, "Flags": 0b01010000}, cpu.incR('x'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.IX = 0x027f
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0280, "Flags": 0b10010100}, cpu.incR('x'))
}
...
func TestIncIYL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0211, "Flags": 0b00000001}, cpu.incR('y'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.IY = 0x02ff
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0200, "Flags": 0b01010000}, cpu.incR('y'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.IY = 0x027f
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0280, "Flags": 0b10010100}, cpu.incR('y'))
}
...
func TestDecL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x0200, "Flags": 0b01000011}, cpu.decR('L'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.HL = 0x0200
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x02ff, "Flags": 0b10111010}, cpu.decR('L'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.HL = 0x0280
	checkCpu(t, 4, map[string]uint16{"PC": 1, "HL": 0x027f, "Flags": 0b00111110}, cpu.decR('L'))
}
...
func TestDecIXL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x0200, "Flags": 0b01000011}, cpu.decR('x'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.IX = 0x0200
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x02ff, "Flags": 0b10111010}, cpu.decR('x'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.IX = 0x0280
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IX": 0x027f, "Flags": 0b00111110}, cpu.decR('x'))
}
...
func TestDecIYL(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x0200, "Flags": 0b01000011}, cpu.decR('y'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.IY = 0x0200
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x02ff, "Flags": 0b10111010}, cpu.decR('y'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.IY = 0x0280
	checkCpu(t, 4, map[string]uint16{"PC": 2, "IY": 0x027f, "Flags": 0b00111110}, cpu.decR('y'))
}
...
func TestCpl(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x18, "Flags": 0b00011010}, cpu.cpl)
}
...
func TestJrNcN(t *testing.T) {
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x37, "WZ": 0x37, "Flags": 0b11010110}, cpu.jrNcN)
	...
	checkCpu(t, 7, map[string]uint16{"PC": 0x05, "WZ": 0x37, "Flags": 0b11010111}, cpu.jrNcN)
}
...
func TestLd_Nn_A(t *testing.T) {
	...
	checkCpu(t, 13, map[string]uint16{"PC": 3, "A": 0xd7, "WZ": 0xd742}, cpu.ld_Nn_A)

	got := dmaX.GetMemoryByte(0x3141)
	want := uint8(0xd7)
...
func TestInc_Hl_(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "HL": 0x3572, "Flags": 0b00100001}, cpu.inc_Ss_("HL"))

	got := dmaX.GetMemoryByte(0x3572)
	want := uint8(0x26)
...
func TestDec_Hl_(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "HL": 0x3572, "Flags": 0b10111010}, cpu.dec_Ss_("HL"))
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "HL": 0x3572, "Flags": 0b00111110}, cpu.dec_Ss_("HL"))
...
func TestScf(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "Flags": 0b11100101}, cpu.scf)
...
func TestJrCN(t *testing.T) {
	...
	checkCpu(t, 12, map[string]uint16{"PC": 0x37, "WZ": 0x37, "Flags": 0b11010111}, cpu.jrCN)
	...
	checkCpu(t, 7, map[string]uint16{"PC": 0x05, "WZ": 0x37, "Flags": 0b11010110}, cpu.jrCN)
}
...
func TestAddHlSp(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "SP": 0xa76c, "HL": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("HL", "SP"))
	...
	checkCpu(t, 11, map[string]uint16{"PC": 1, "SP": 0x7fff, "HL": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("HL", "SP"))
}
...
func TestAddIxSp(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "SP": 0xa76c, "IX": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IX", "SP"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "SP": 0x7fff, "IX": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IX", "SP"))
}
...
func TestAddIySp(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "SP": 0xa76c, "IY": 0x009f, "WZ": 0x5934, "Flags": 0b00010001}, cpu.addSsRr("IY", "SP"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "SP": 0x7fff, "IY": 0xfffe, "WZ": 0x8000, "Flags": 0b00111000}, cpu.addSsRr("IY", "SP"))
}
...
func TestLdA_Nn_(t *testing.T) {
	...
	checkCpu(t, 13, map[string]uint16{"PC": 3, "A": 0x64, "WZ": 0x1258}, cpu.ldA_Nn_)
}
...
func TestIncA(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x11, "Flags": 0b00000001}, cpu.incR('A'))

	resetAll()
	cpu.setFlags(0b10000110)
	cpu.setAcc(0xff)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x00, "Flags": 0b01010000}, cpu.incR('A'))

	resetAll()
	cpu.setFlags(0b01000010)
	cpu.setAcc(0x7f)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x80, "Flags": 0b10010100}, cpu.incR('A'))
}
...
func TestDecA(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x00, "Flags": 0b01000011}, cpu.decR('A'))

	resetAll()
	cpu.setFlags(0b01000100)
	cpu.setAcc(0x00)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0xff, "Flags": 0b10111010}, cpu.decR('A'))

	resetAll()
	cpu.setFlags(0b11000000)
	cpu.setAcc(0x80)
	checkCpu(t, 4, map[string]uint16{"PC": 1, "A": 0x7f, "Flags": 0b00111110}, cpu.decR('A'))
}
...
func TestCcf(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 1, "Flags": 0b11101101}, cpu.ccf)
...
func TestAnd_Ix_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01010100}, cpu.and_Ss_("IX"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10010000}, cpu.and_Ss_("IX"))
}
...
func TestAnd_Iy_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01010100}, cpu.and_Ss_("IY"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10010000}, cpu.and_Ss_("IY"))
}
...
func TestXor_Ix_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01000100}, cpu.xor_Ss_("IX"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.xor_Ss_("IX"))
}
...
func TestXor_Iy_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01000100}, cpu.xor_Ss_("IY"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.xor_Ss_("IY"))
}
...
func TestOr_Ix_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01000100}, cpu.or_Ss_("IX"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.or_Ss_("IX"))
}
...
func TestOr_Iy_(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x00, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01000100}, cpu.or_Ss_("IY"))
	...
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x97, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.or_Ss_("IY"))
}
...
func TestJpNzNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b10010111}, cpu.jpNzNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpNzNn)
}
...
func TestJpNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678}, cpu.jpNn)
}
...
func TestCallNzNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "SP": 0xfffe, "WZ": 0x5678, "Flags": 0b10010111}, cpu.callNzNn)

	gotL, gotH := dmaX.GetMemoryByte(0xfffe), dmaX.GetMemoryByte(0xffff)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "SP": 0x0000, "WZ": 0x5678, "Flags": 0b11010111}, cpu.callNzNn)
...
func TestRst(t *testing.T) {
	for _, addr := range []uint8{0x00, 0x08, 0x10, 0x18, 0x20, 0x28, 0x30, 0x38} {
		...
		checkCpu(t, 11, map[string]uint16{"PC": uint16(addr), "WZ": uint16(addr), "SP": 0xfffe}, cpu.rst(addr))
...
func TestRet(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe}, cpu.ret)
}
...
func TestJpZNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpZNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b10010111}, cpu.jpZNn)
}
...
func TestCallZNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010111}, cpu.callZNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b10010111}, cpu.callZNn)
...
func TestCallNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe}, cpu.callNn)
...
func TestJpNcNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b11010110}, cpu.jpNcNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpNcNn)
}
...
func TestOut_N_A(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 2, "A": 0xaf, "WZ": 0xaf46}, cpu.out_N_A)
...
func TestCallNcNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010110}, cpu.callNcNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b11010111}, cpu.callNcNn)
...
func TestJpCNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpCNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010110}, cpu.jpCNn)
}
...
func TestInA_N_(t *testing.T) {
	...
	checkCpu(t, 11, map[string]uint16{"PC": 2, "WZ": 0x1146, "A": 0xaf}, cpu.inA_N_)
}
...
func TestCallCNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010111}, cpu.callCNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b11010110}, cpu.callCNn)
...
func TestJpPoNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b11010011}, cpu.jpPoNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpPoNn)
}
...
func TestEx_Sp_Hl(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 1, "HL": 0x2211, "SP": 0x8856, "WZ": 0x2211}, cpu.ex_Sp_Ss("HL"))

	gotL, gotH := dmaX.GetMemoryByte(0x8856), dmaX.GetMemoryByte(0x8857)
...
func TestCallPoNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010011}, cpu.callPoNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b11010111}, cpu.callPoNn)
...
func TestAndN(t *testing.T) {
	...
	checkCpu(t, 7, map[string]uint16{"PC": 2, "A": 0x00, "Flags": 0b01010100}, cpu.andN)

	resetAll()
	cpu.setAcc(0xdf)
	dmaX.SetMemoryByte(0x0001, 0xb7)

	checkCpu(t, 7, map[string]uint16{"PC": 2, "A": 0x97, "Flags": 0b10010000}, cpu.andN)
}
...
func TestJp_Hl_(t *testing.T) {
	...
	checkCpu(t, 4, map[string]uint16{"PC": 0x1234, "HL": 0x1234}, cpu.jp_Ss_("HL"))
}
...
func TestJp_Ix_(t *testing.T) {
	...
	checkCpu(t, 8, map[string]uint16{"PC": 0x1234, "IX": 0x1234}, cpu.jp_Ss_("IX"))
}
...
func TestJp_Iy_(t *testing.T) {
	...
	checkCpu(t, 8, map[string]uint16{"PC": 0x1234, "IY": 0x1234}, cpu.jp_Ss_("IY"))
}
...
func TestJpPeNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpPeNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010011}, cpu.jpPeNn)
}
...
func TestCallPeNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010111}, cpu.callPeNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b11010011}, cpu.callPeNn)
...
func TestJpPNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "Flags": 0b01010111}, cpu.jpPNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b11010111}, cpu.jpPNn)
}
...
func TestCallPNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b01010111}, cpu.callPNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b11010111}, cpu.callPNn)
...
func TestJpMNn(t *testing.T) {
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x06, "WZ": 0x5678, "Flags": 0b01010111}, cpu.jpMNn)
}
...
func TestCallMNn(t *testing.T) {
	...
	checkCpu(t, 17, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe, "Flags": 0b11010111}, cpu.callMNn)
	...
	checkCpu(t, 10, map[string]uint16{"PC": 0x1237, "WZ": 0x5678, "SP": 0x0000, "Flags": 0b01010111}, cpu.callMNn)
...
func TestInR_C_(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A', ' '} {
		...
		switch register {
		case ' ':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x0034, "WZ": 0x0035, "Flags": 0b10000101}, cpu.inR_C_(register))
		case 'A':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x0034, "A": 0x8b, "WZ": 0x0035, "Flags": 0b10000101}, cpu.inR_C_(register))
		case 'B':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x8b34, "WZ": 0x8b35, "Flags": 0b10000101}, cpu.inR_C_(register))
		case 'C':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x008b, "WZ": 0x008c, "Flags": 0b10000101}, cpu.inR_C_(register))
		default:
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x0034, expectedRegisterMap[register]: expectedValueMap[register], "WZ": 0x0035, "Flags": 0b10000101}, cpu.inR_C_(register))
		}
		...
		switch register {
		case ' ':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0xff34, "WZ": 0xff35, "Flags": 0b01000100}, cpu.inR_C_(register))
		case 'A':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0xff34, "WZ": 0xff35, "A": 0x00, "Flags": 0b01000100}, cpu.inR_C_(register))
		case 'B':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0x0034, "WZ": 0x0035, "Flags": 0b01000100}, cpu.inR_C_(register))
		case 'C':
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0xff00, "WZ": 0xff01, "Flags": 0b01000100}, cpu.inR_C_(register))
		default:
			checkCpu(t, 12, map[string]uint16{"PC": 2, "BC": 0xff34, expectedRegisterMap[register]: expectedValueMap[register], "WZ": 0xff35, "Flags": 0b01000100}, cpu.inR_C_(register))
		}
	}
}
...
func TestOut_C_R(t *testing.T) {
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A', ' '} {
		...
		if register == 'A' {
			checkCpu(t, 12, map[string]uint16{"PC": 2, "A": 0x8b, "BC": 0x8b34, "DE": 0x8b8b, "HL": 0x8b8b, "WZ": 0x8b35}, cpu.out_C_R(register))
		} else {
			checkCpu(t, 12, map[string]uint16{"PC": 2, "A": 0x8b, "BC": 0x8b34, "DE": 0x8b8b, "HL": 0x8b8b, "WZ": 0x0001}, cpu.out_C_R(register))
		}
...
func TestLd_Nn_Rr(t *testing.T) {
	for _, registerPair := range [4]string{"BC", "DE", "HL", "SP"} {
		...
		checkCpu(t, 20, map[string]uint16{"PC": 4, "BC": 0x4644, "DE": 0x4644, "HL": 0x4644, "SP": 0x4644, "WZ": 0x1021}, cpu.ld_Nn_Rr(registerPair))

		gotL, gotH := dmaX.GetMemoryByte(0x1020), dmaX.GetMemoryByte(0x1021)
...
func TestReti(t *testing.T) {
	...
	checkCpu(t, 14, map[string]uint16{"PC": 0x5678, "WZ": 0x5678, "SP": 0xfffe}, cpu.reti)
...
func TestLdRr_Nn_(t *testing.T) {
	for _, registerPair := range [4]string{"BC", "DE", "HL", "SP"} {
		...
		checkCpu(t, 20, map[string]uint16{"PC": 4, registerPair: 0x2485, "WZ": 0x1021}, cpu.ldRr_Nn_(registerPair))
	}
}
...
func TestRrd(t *testing.T) {
	...
	checkCpu(t, 18, map[string]uint16{"PC": 2, "A": 0x80, "HL": 0x5000, "WZ": 0x5001, "Flags": 0b10000001}, cpu.rrd)

	got := dmaX.GetMemoryByte(0x5000)
	want := uint8(0x42)
...
func TestRld(t *testing.T) {
	...
	checkCpu(t, 18, map[string]uint16{"PC": 2, "A": 0x73, "HL": 0x5000, "WZ": 0x5001, "Flags": 0b00100001}, cpu.rld)
...
func TestLdR_IXd_(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0xab34, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('B', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x12ab, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('C', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0xab34, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('D', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x12ab, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('E', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0xab34, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('H', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x12ab, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('L', "IX"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0xab, "IX": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('A', "IX"))
}
...
func TestLdR_IYd_(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0xab34, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('B', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x12ab, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('C', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0xab34, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('D', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x12ab, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('E', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0xab34, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('H', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x12ab, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('L', "IY"))
	...
	dmaX.SetMemoryByte(0x5691, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0xab, "IY": 0x5678, "WZ": 0x5691}, cpu.ldR_Ss_('A', "IY"))
}
...
func TestLd_Ix_R(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'B'))

	got := dmaX.GetMemoryByte(0x5691)
	want := uint8(0x12)
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'C'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'D'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'E'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'H'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x1234, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'L'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x12, "IX": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IX", 'A'))
...
func TestLd_Iy_R(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'B'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "BC": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'C'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'D'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "DE": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'E'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'H'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "HL": 0x1234, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'L'))
	...
	dmaX.SetMemoryByte(0x5678, 0xab)
	dmaX.SetMemoryByte(0x0002, 0x19)
	checkCpu(t, 19, map[string]uint16{"PC": 3, "A": 0x12, "IY": 0x5678, "WZ": 0x5691}, cpu.ld_Ss_R("IY", 'A'))
...
func TestLd_Ix_N(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 4, "IX": 0x1015, "WZ": 0x102e}, cpu.ld_Ss_N("IX"))

	got := dmaX.GetMemoryByte(0x102e)
	want := uint8(0x28)
	if got != want {
		t.Errorf("got %x, want %x", got, want)
	}
...
func TestLd_Iy_N(t *testing.T) {
	...
	checkCpu(t, 19, map[string]uint16{"PC": 4, "IY": 0x1015, "WZ": 0x102e}, cpu.ld_Ss_N("IY"))
...
func TestLdIx_Nn_(t *testing.T) {
	...
	checkCpu(t, 20, map[string]uint16{"PC": 4, "IX": 0xa137, "WZ": 0xb22a}, cpu.ldSs_Nn_("IX"))
}
...
func TestLdIy_Nn_(t *testing.T) {
	...
	checkCpu(t, 20, map[string]uint16{"PC": 4, "IY": 0xa137, "WZ": 0xb22a}, cpu.ldSs_Nn_("IY"))
}
...
func TestLd_Nn_Ix(t *testing.T) {
	...
	checkCpu(t, 20, map[string]uint16{"PC": 4, "IX": 0x483a, "WZ": 0xb22a}, cpu.ld_Nn_Ss("IX"))
...
func TestLd_Nn_Iy(t *testing.T) {
	...
	checkCpu(t, 20, map[string]uint16{"PC": 4, "IY": 0x483a, "WZ": 0xb22a}, cpu.ld_Nn_Ss("IY"))
...
func TestEx_Sp_Ix(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 2, "IX": 0x2211, "SP": 0x8856, "WZ": 0x2211}, cpu.ex_Sp_Ss("IX"))
...
func TestEx_Sp_Iy(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 2, "IY": 0x2211, "SP": 0x8856, "WZ": 0x2211}, cpu.ex_Sp_Ss("IY"))
...
func TestInc_Ix_(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b00100001}, cpu.inc_Ss_("IX"))
	...
	dmaX.SetMemoryByte(0x0002, 0x33)
	dmaX.SetMemoryByte(0x3572, 0xff)
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b01010000}, cpu.inc_Ss_("IX"))
	...
	dmaX.SetMemoryByte(0x0002, 0x33)
	dmaX.SetMemoryByte(0x3572, 0x7f)
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b10010100}, cpu.inc_Ss_("IX"))
...
func TestInc_Iy_(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b00100001}, cpu.inc_Ss_("IY"))
	...
	dmaX.SetMemoryByte(0x0002, 0x33)
	dmaX.SetMemoryByte(0x3572, 0xff)
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b01010000}, cpu.inc_Ss_("IY"))
	...
	dmaX.SetMemoryByte(0x0002, 0x33)
	dmaX.SetMemoryByte(0x3572, 0x7f)
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b10010100}, cpu.inc_Ss_("IY"))
...
func TestDec_Ix_(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b01000011}, cpu.dec_Ss_("IX"))
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b10111010}, cpu.dec_Ss_("IX"))
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IX": 0x353f, "WZ": 0x3572, "Flags": 0b00111110}, cpu.dec_Ss_("IX"))
...
func TestDec_Iy_(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b01000011}, cpu.dec_Ss_("IY"))
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b10111010}, cpu.dec_Ss_("IY"))
	...
	checkCpu(t, 23, map[string]uint16{"PC": 3, "IY": 0x353f, "WZ": 0x3572, "Flags": 0b00111110}, cpu.dec_Ss_("IY"))
...
func TestCpi(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0x3b, "HL": 0x1112, "BC": 0x0000, "WZ": 0x1246, "Flags": 0b01000011}, cpu.cpi)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0x00, "HL": 0x1112, "BC": 0x7fff, "WZ": 0x1246, "Flags": 0b10010110}, cpu.cpi)
...
func TestIni(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1001, "BC": 0x0f07, "WZ": 0x1008, "Flags": 0b00001010}, cpu.ini)

	got := dmaX.GetMemoryByte(0x1000)
	want := uint8(0x7b)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1001, "BC": 0x0007, "WZ": 0x0108, "Flags": 0b11010111}, cpu.ini)
...
func TestOuti(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1001, "BC": 0x0f07, "WZ": 0x0f08, "Flags": 0b00001010}, cpu.outi)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1001, "BC": 0x0007, "WZ": 0x0008, "Flags": 0b11010111}, cpu.outi)
...
func TestCpd(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0x3b, "HL": 0x1110, "BC": 0x0000, "WZ": 0x1246, "Flags": 0b01000011}, cpu.cpd)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0x00, "HL": 0x1110, "BC": 0x7fff, "WZ": 0x1246, "Flags": 0b10010110}, cpu.cpd)
...
func TestInd(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0fff, "BC": 0x0f07, "WZ": 0x1006, "Flags": 0b00001010}, cpu.ind)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0fff, "BC": 0x0007, "WZ": 0x0106, "Flags": 0b11010111}, cpu.ind)
...
func TestOutd(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0fff, "BC": 0x0f07, "WZ": 0x0f06, "Flags": 0b00001010}, cpu.outd)
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0fff, "BC": 0x0007, "WZ": 0x0006, "Flags": 0b11010111}, cpu.outd)
...
func TestLdir(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1114, "DE": 0x2225, "BC": 0x0000, "WZ": 0x0001, "Flags": 0b11100001}, cpu.ldir)

	gotHLA, gotHLB, gotHLC := dmaX.GetMemoryByte(0x1111), dmaX.GetMemoryByte(0x1112), dmaX.GetMemoryByte(0x1113)
	...
	gotDEA, gotDEB, gotDEC := dmaX.GetMemoryByte(0x2222), dmaX.GetMemoryByte(0x2223), dmaX.GetMemoryByte(0x2224)
...
func TestCpir(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0xf3, "HL": 0x1114, "BC": 0x0004, "WZ": 0x0002, "Flags": 0b01000111}, cpu.cpir)
...
func TestInir(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1003, "BC": 0x0007, "WZ": 0x0108, "Flags": 0b01000010}, cpu.inir)

	gotA, gotB, gotC := dmaX.GetMemoryByte(0x1000), dmaX.GetMemoryByte(0x1001), dmaX.GetMemoryByte(0x1002)
...
func TestOtir(t *testing.T) {
	...
	for i := 0x1000; cpu.BC > 512; i++ {
		...
		wantT, wantPort := uint8(21), uint8(dmaX.GetMemoryByte(uint16(i)))
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1003, "BC": 0x0007, "WZ": 0x0008, "Flags": 0b01000010}, cpu.otir)
...
func TestLddr(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x1111, "DE": 0x2222, "BC": 0x0000, "WZ": 0x0001, "Flags": 0b11100001}, cpu.lddr)

	gotHLA, gotHLB, gotHLC := dmaX.GetMemoryByte(0x1112), dmaX.GetMemoryByte(0x1113), dmaX.GetMemoryByte(0x1114)
	wantHLA, wantHLB, wantHLC := uint8(0x88), uint8(0x36), uint8(0xa5)
	...
	gotDEA, gotDEB, gotDEC := dmaX.GetMemoryByte(0x2223), dmaX.GetMemoryByte(0x2224), dmaX.GetMemoryByte(0x2225)
	wantDEA, wantDEB, wantDEC := uint8(0x88), uint8(0x36), uint8(0xa5)
...
func TestCpdr(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "A": 0xf3, "HL": 0x1115, "BC": 0x0004, "WZ": 0x0000, "Flags": 0b01000111}, cpu.cpdr)

	gotHLA, gotHLB, gotHLC := dmaX.GetMemoryByte(0x1116), dmaX.GetMemoryByte(0x1117), dmaX.GetMemoryByte(0x1118)
...
func TestIndr(t *testing.T) {
	...
	cpu.setPort(0x07, ports[2])
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0ffd, "BC": 0x0007, "WZ": 0x0106, "Flags": 0b01000010}, cpu.indr)

	gotA, gotB, gotC := dmaX.GetMemoryByte(0x0ffe), dmaX.GetMemoryByte(0x0fff), dmaX.GetMemoryByte(0x1000)
...
func TestOtdr(t *testing.T) {
	...
	checkCpu(t, 16, map[string]uint16{"PC": 2, "HL": 0x0ffd, "BC": 0x0007, "WZ": 0x0006, "Flags": 0b01000010}, cpu.otdr)
...
func TestRlcR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x19, "Flags": 0b00001001}, cpu.rlcR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b00001001}, cpu.rlcR(register))
		}
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x9a, "Flags": 0b10001100}, cpu.rlcR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10001100}, cpu.rlcR(register))
		}
	}
}
...
func TestRlcHl(t *testing.T) {
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b00001001}, cpu.rlcSs("HL"))

	got := dmaX.GetMemoryByte(0x1234)
	want := uint8(0x19)
	...
	cpu.setFlags(0b11010111)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b10001100}, cpu.rlcSs("HL"))
...
func TestRlcIx(t *testing.T) {
	...
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00001001}, cpu.rlcSs("IX"))
	...
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	cpu.setFlags(0b11010111)
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10001100}, cpu.rlcSs("IX"))
...
func TestRlcIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00001001}, cpu.rlcSs("IY"))
	...
	cpu.setFlags(0b11010111)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10001100}, cpu.rlcSs("IY"))
...
func TestRrcR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x26, "Flags": 0b00100000}, cpu.rrcR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b00100000}, cpu.rrcR(register))
		}
	}
}
...
func TestRrcHl(t *testing.T) {
	...
	cpu.setFlags(0b11010111)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b00100000}, cpu.rrcSs("HL"))
...
func TestRrcIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8d)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10000101}, cpu.rrcSs("IX"))
	...
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	cpu.setFlags(0b11010111)
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00100000}, cpu.rrcSs("IX"))
...
func TestRrcIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8d)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10000101}, cpu.rrcSs("IY"))
	...
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	cpu.setFlags(0b11010111)
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00100000}, cpu.rrcSs("IY"))
...
func TestRlR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x18, "Flags": 0b00001101}, cpu.rlR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b00001101}, cpu.rlR(register))
		}
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x9b, "Flags": 0b10001000}, cpu.rlR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10001000}, cpu.rlR(register))
		}
	}
}
...
func TestRlHl(t *testing.T) {
	...
	cpu.setFlags(0b11010110)
	dmaX.SetMemoryByte(0x1234, 0x8c)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b00001101}, cpu.rlSs("HL"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4d)
	cpu.setFlags(0b11010111)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b10001000}, cpu.rlSs("HL"))
...
func TestRlIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00001101}, cpu.rlSs("IX"))
	...
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	cpu.setFlags(0b11010111)
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10001000}, cpu.rlSs("IX"))
...
func TestRlIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00001101}, cpu.rlSs("IY"))
	...
	cpu.setFlags(0b11010111)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10001000}, cpu.rlSs("IY"))
...
func TestRrR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0xa6, "Flags": 0b10100100}, cpu.rrR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10100100}, cpu.rrR(register))
		}
	}
}
...
func TestRrHl(t *testing.T) {
	...
	cpu.setFlags(0b11010111)
	dmaX.SetMemoryByte(0x1234, 0x4c)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b10100100}, cpu.rrSs("HL"))
...
func TestRrIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8d)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00000001}, cpu.rrSs("IX"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10100100}, cpu.rrSs("IX"))
...
func TestRrIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x8d)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00000001}, cpu.rrSs("IY"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10100100}, cpu.rrSs("IY"))
...
func TestSlaR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x98, "Flags": 0b10001000}, cpu.slaR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10001000}, cpu.slaR(register))
		}
	}
}
...
func TestSlaHl(t *testing.T) {
	...
	cpu.setFlags(0b11010111)
	dmaX.SetMemoryByte(0x1234, 0x4c)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b10001000}, cpu.slaSs("HL"))
...
func TestSlaIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x80)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.slaSs("IX"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10001000}, cpu.slaSs("IX"))
...
func TestSlaIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x80)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.slaSs("IY"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10001000}, cpu.slaSs("IY"))
...
func TestSraIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x01)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.sraSs("IX"))
	...
	dmaX.SetMemoryByte(0x1234, 0x8e)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.sraSs("IX"))
...
func TestSraIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x01)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.sraSs("IY"))
	...
	dmaX.SetMemoryByte(0x1234, 0x8e)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10000000}, cpu.sraSs("IY"))
...
func TestSllR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x99, "Flags": 0b10001100}, cpu.sllR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10001100}, cpu.sllR(register))
		}
	}
}
...
func TestSllHl(t *testing.T) {
	...
	cpu.setFlags(0b11010111)
	dmaX.SetMemoryByte(0x1234, 0x4c)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b10001100}, cpu.sllSs("HL"))
...
func TestSllIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x80)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00000001}, cpu.sllSs("IX"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b10001100}, cpu.sllSs("IX"))
...
func TestSllIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x80)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00000001}, cpu.sllSs("IY"))
	...
	dmaX.SetMemoryByte(0x1234, 0x4c)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b10001100}, cpu.sllSs("IY"))
...
func TestSrlR(t *testing.T) {
	...
	for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
		...
		switch register {
		case 'A':
			checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x67, "Flags": 0b00100000}, cpu.srlR(register))
		default:
			checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b00100000}, cpu.srlR(register))
		}
	}
}
...
func TestSrlHl(t *testing.T) {
	...
	cpu.setFlags(0b11010110)
	dmaX.SetMemoryByte(0x1234, 0x01)
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b01000101}, cpu.srlSs("HL"))
	...
	checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234, "Flags": 0b00100000}, cpu.srlSs("HL"))
...
func TestSrlIx(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x01)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.srlSs("IX"))
	...
	dmaX.SetMemoryByte(0x1234, 0xce)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b00100000}, cpu.srlSs("IX"))
...
func TestSrlIy(t *testing.T) {
	...
	dmaX.SetMemoryByte(0x1234, 0x01)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01000101}, cpu.srlSs("IY"))
	...
	dmaX.SetMemoryByte(0x1234, 0xce)
	dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
	checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b00100000}, cpu.srlSs("IY"))
...
func TestBitBR(t *testing.T) {
	...
	for bit := uint8(0); bit < 8; bit++ {
		for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
			...
			switch register {
			case 'A':
				checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0xff, "Flags": 0b10111000 & ((1 << bit) | 0x7f)}, cpu.bitBR(bit, register))
			default:
				checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b10111000 & ((1 << bit) | 0x7f)}, cpu.bitBR(bit, register))
			}
			...
			switch register {
			case 'A':
				checkCpu(t, 8, map[string]uint16{"PC": 2, "A": 0x00, "Flags": 0b01010100}, cpu.bitBR(bit, register))
			default:
				checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register], "Flags": 0b01010100}, cpu.bitBR(bit, register))
			}
		}
	}
}
...
func TestBitBHl(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		checkCpu(t, 12, map[string]uint16{"PC": 2, "HL": 0x1234, "WZ": 0x2800, "Flags": 0b10111000 & ((1 << bit) | 0x7f)}, cpu.bitBSs(bit, "HL"))
		...
		dmaX.SetMemoryByte(0x1234, 0x00)
		checkCpu(t, 12, map[string]uint16{"PC": 2, "HL": 0x1234, "WZ": 0x0000, "Flags": 0b01010100}, cpu.bitBSs(bit, "HL"))
...
func TestBitBIx(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 20, map[string]uint16{"PC": 4, "IX": 0x281b, "WZ": 0x2834, "Flags": 0b10111000 & ((1 << bit) | 0x7f)}, cpu.bitBSs(bit, "IX"))

		got := dmaX.GetMemoryByte(0x2834)
		want := uint8(0xff)
		...
		dmaX.SetMemoryByte(0x1234, 0x00)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 20, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234, "Flags": 0b01010100}, cpu.bitBSs(bit, "IX"))
...
func TestBitBIy(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryByte(0x2834, 0xff)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 20, map[string]uint16{"PC": 4, "IY": 0x281b, "WZ": 0x2834, "Flags": 0b10111000 & ((1 << bit) | 0x7f)}, cpu.bitBSs(bit, "IY"))
		...
		dmaX.SetMemoryByte(0x1234, 0x00)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 20, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234, "Flags": 0b01010100}, cpu.bitBSs(bit, "IY"))
...
func TestSetBR(t *testing.T) {
	...
	for bit := uint8(0); bit < 8; bit++ {
		for _, register := range []byte{'B', 'C', 'D', 'E', 'H', 'L', 'A'} {
			...
			switch register {
			case 'A':
				checkCpu(t, 8, map[string]uint16{"PC": 2, "A": mask}, cpu.setBR(bit, register))
			default:
				checkCpu(t, 8, map[string]uint16{"PC": 2, expectedRegisterMap[register]: expectedValueMap[register]}, cpu.setBR(bit, register))
			}
		}
	}
}
...
func TestSetBHl(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		cpu.HL = 0x1234
		dmaX.SetMemoryByte(0x1234, 0x00)
		checkCpu(t, 15, map[string]uint16{"PC": 2, "HL": 0x1234}, cpu.setBSs(bit, "HL"))
...
func TestSetBIx(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryByte(0x1234, 0x00)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234}, cpu.setBSs(bit, "IX"))
...
func TestSetBIy(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryByte(0x1234, 0x00)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234}, cpu.setBSs(bit, "IY"))
...
func TestResBIx(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryByte(0x1234, 0xff)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 23, map[string]uint16{"PC": 4, "IX": 0x121b, "WZ": 0x1234}, cpu.resBSs(bit, "IX"))
...
func TestResBIy(t *testing.T) {
	for bit := uint8(0); bit < 8; bit++ {
		...
		dmaX.SetMemoryByte(0x1234, 0xff)
		dmaX.SetMemoryBulk(0x0000, []uint8{0xdd, 0xcb, 0x19, 0x06})
		checkCpu(t, 23, map[string]uint16{"PC": 4, "IY": 0x121b, "WZ": 0x1234}, cpu.resBSs(bit, "IY"))
